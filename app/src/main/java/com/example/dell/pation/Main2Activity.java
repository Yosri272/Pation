...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recitem1);
        madapter = new doctoradapter(doctorList);

        recyclerView.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
        recyclerView.setAdapter(madapter);
      recyclerView.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {
            GestureDetector gestureDetector = new GestureDetector(Main2Activity.this, new GestureDetector.SimpleOnGestureListener() {
                @Override
            ...
            public boolean onInterceptTouchEvent(RecyclerView Recyclerview, MotionEvent motionEvent) {
                ...
                if(ChildView != null && gestureDetector.onTouchEvent(motionEvent)) {
                 ...
                 //   Toast.makeText(Main2Activity.this,  ""+RecyclerViewItemPosition, Toast.LENGTH_LONG).show();
                    ...
                    Intent i=new Intent(Main2Activity.this,display.class);
    ...
    protected void showList() {
        ...
        StringRequest str = new StringRequest(Request.Method.GET, "http://192.168.43.34/hassan/Api.php",
   ...
   /* public void booked(View view) {
        Toast.makeText(Main2Activity.this,a0, Toast.LENGTH_SHORT).show();

        Intent x = new Intent(Main2Activity.this,choose.class);
        x.putExtra("name1",a0);
        startActivity(x);
        Toast.makeText(Main2Activity.this,a0, Toast.LENGTH_SHORT).show();

...
public class Main3Activity extends AppCompatActivity {
    ...
    private doctoradapter1 madapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recitem2);
        a =getIntent().getExtras().getString("spe");
        b =getIntent().getExtras().getString("d_address");


        madapter = new doctoradapter1(doctorList);
        recyclerView.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
        recyclerView.setAdapter(madapter);
        recyclerView.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {
            GestureDetector gestureDetector = new GestureDetector(Main3Activity.this, new GestureDetector.SimpleOnGestureListener() {
                @Override
    ...
    protected void showList() {
        ...
        StringRequest str = new StringRequest(Request.Method.GET, "http://192.168.43.34/hassan/S1.php?d_spe=" + a.toString() +"&d_address="+b.toString(),
            ...
            public void onErrorResponse(VolleyError volleyError) {
                Toast.makeText(Main3Activity.this, "الخادم غير متصل", Toast.LENGTH_SHORT).show();
            }
        });
        rq.add(str);
    ...
    public void booked1(View view) {


       Intent x = new Intent(Main3Activity.this,choose.class);
       x.putExtra("name1", a0);
        startActivity(x);
    }
}
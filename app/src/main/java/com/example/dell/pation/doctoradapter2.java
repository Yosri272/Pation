...
public class doctoradapter2 extends RecyclerView.Adapter<doctoradapter2.MyViewHolder> {
    ...
    public doctoradapter2(List<doctor> doctorlist) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_find3, parent, false);
